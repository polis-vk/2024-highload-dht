...
На графике хорошо заметно, что, до 99-го перцентиля есть некоторое плато. Вероятнее всего часть ресурсов было отнято jit
компиляцией, после которой запросы стали обрабатываться быстрее.
Также видно, что есть плато после 99.999-го перцентиля. И ЧТО???
